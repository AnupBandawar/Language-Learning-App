...
public class NumbersActivity extends AppCompatActivity {
    ...
    private AudioManager mAudioManagaer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAudioManagaer = (AudioManager) getSystemService(Context.AUDIO_SERVICE);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
               Word word = words.get(i);
                ...
                int result = mAudioManagaer.requestAudioFocus(mOnAudioFocusChangeListener,
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    mAudioManagaer.registerMediaButtonEventReceiver(RemoteControlReceiver);
    ...
    private void releaseMediaPlayer() {
        ...
        if (mMediaPlayer != null) {
            ...
            mAudioManagaer.abandonAudioFocus(mOnAudioFocusChangeListener);
        }
    }
}